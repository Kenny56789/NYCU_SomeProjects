...
BEGIN_MESSAGE_MAP(CRecordPlayApp, CWinApp)
...
// 唯一一個 CRecordPlayApp 物件

CRecordPlayApp theApp;


// CRecordPlayApp 初始化

BOOL CRecordPlayApp::InitInstance()
{
